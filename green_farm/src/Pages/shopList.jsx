      ...
      <div className="col-lg-12 mb-sm-35 mb-xs-35">
        ...
        <div className="shop-page-banner mb-35">
          <a href="shop-left-sidebar.html">
            <img width={870} height={331} src="assets/images/banners/shop-banner.webp" className="img-fluid" alt="" />
          </a>
        </div>
          ...
          <div className="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-12">
            ...
            <div className="gf-product shop-grid-view-product">
              <div className="image">
                <a href="single-product.html">
                  <span className="onsale">Sale!</span>
                  <img width={350} height={350} src="assets/images/products/product06.webp" className="img-fluid" alt="" />
                </a>
                <div className="product-hover-icons">
                  <a href="#" data-tooltip="Add to cart"> <span className="icon_cart_alt" /></a>
                  <a href="#" data-tooltip="Add to wishlist"> <span className="icon_heart_alt" /> </a>
          ...
          <div className="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-12">
            ...
            <div className="gf-product shop-grid-view-product">
              <div className="image">
                <a href="single-product.html">
                  <span className="onsale">Sale!</span>
                  <img width={350} height={350} src="assets/images/products/product07.webp" className="img-fluid" alt="" />
                </a>
                <div className="product-hover-icons">
                  <a href="#" data-tooltip="Add to cart"> <span className="icon_cart_alt" /></a>
                  <a href="#" data-tooltip="Add to wishlist"> <span className="icon_heart_alt" /> </a>
          ...
          <div className="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-12">
            ...
            <div className="gf-product shop-grid-view-product">
              <div className="image">
                <a href="single-product.html">
                  <span className="onsale">Sale!</span>
                  <img width={350} height={350} src="assets/images/products/product08.webp" className="img-fluid" alt="" />
                </a>
                <div className="product-hover-icons">
                  <a href="#" data-tooltip="Add to cart"> <span className="icon_cart_alt" /></a>
                  <a href="#" data-tooltip="Add to wishlist"> <span className="icon_heart_alt" /> </a>
          ...
          <div className="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-12">
            ...
            <div className="gf-product shop-grid-view-product">
              <div className="image">
                <a href="single-product.html">
                  <span className="onsale">Sale!</span>
                  <img width={350} height={350} src="assets/images/products/product10.webp" className="img-fluid" alt="" />
                </a>
                <div className="product-hover-icons">
                  <a href="#" data-tooltip="Add to cart"> <span className="icon_cart_alt" /></a>
                  <a href="#" data-tooltip="Add to wishlist"> <span className="icon_heart_alt" /> </a>
          ...
          <div className="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-12">
            ...
            <div className="gf-product shop-grid-view-product">
              <div className="image">
                <a href="single-product.html">
                  <span className="onsale">Sale!</span>
                  <img width={350} height={350} src="assets/images/products/product11.webp" className="img-fluid" alt="" />
                </a>
                <div className="product-hover-icons">
                  <a href="#" data-tooltip="Add to cart"> <span className="icon_cart_alt" /></a>
                  <a href="#" data-tooltip="Add to wishlist"> <span className="icon_heart_alt" /> </a>
          ...
          <div className="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-12">
            ...
            <div className="gf-product shop-grid-view-product">
              <div className="image">
                <a href="single-product.html">
                  <span className="onsale">Sale!</span>
                  <img width={350} height={350} src="assets/images/products/product12.webp" className="img-fluid" alt="" />
                </a>
                <div className="product-hover-icons">
                  <a href="#" data-tooltip="Add to cart"> <span className="icon_cart_alt" /></a>
                  <a href="#" data-tooltip="Add to wishlist"> <span className="icon_heart_alt" /> </a>
          ...
          <div className="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-12">
            ...
            <div className="gf-product shop-grid-view-product">
              <div className="image">
                <a href="single-product.html">
                  <span className="onsale">Sale!</span>
                  <img width={350} height={350} src="assets/images/products/product13.webp" className="img-fluid" alt="" />
                </a>
                <div className="product-hover-icons">
                  <a href="#" data-tooltip="Add to cart"> <span className="icon_cart_alt" /></a>
                  <a href="#" data-tooltip="Add to wishlist"> <span className="icon_heart_alt" /> </a>
          ...
          <div className="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-12">
            ...
            <div className="gf-product shop-grid-view-product">
              <div className="image">
                <a href="single-product.html">
                  <span className="onsale">Sale!</span>
                  <img width={350} height={350} src="assets/images/products/product14.webp" className="img-fluid" alt="" />
                </a>
                <div className="product-hover-icons">
                  <a href="#" data-tooltip="Add to cart"> <span className="icon_cart_alt" /></a>
                  <a href="#" data-tooltip="Add to wishlist"> <span className="icon_heart_alt" /> </a>
          ...
          <div className="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-12">
            ...
            <div className="gf-product shop-grid-view-product">
              <div className="image">
                <a href="single-product.html">
                  <span className="onsale">Sale!</span>
                  <img width={350} height={350} src="assets/images/products/product15.webp" className="img-fluid" alt="" />
                </a>
                <div className="product-hover-icons">
                  <a href="#" data-tooltip="Add to cart"> <span className="icon_cart_alt" /></a>
                  <a href="#" data-tooltip="Add to wishlist"> <span className="icon_heart_alt" /> </a>
